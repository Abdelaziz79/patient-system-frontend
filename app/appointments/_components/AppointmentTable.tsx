      ...
      <table className="min-w-full divide-y divide-green-100 dark:divide-green-900">
        <thead className="bg-gradient-to-r from-green-50 to-green-100 dark:from-slate-700 dark:to-slate-700/80">
          <tr>
            <th
              scope="col"
              className="px-6 py-4 text-start text-xs font-medium text-green-700 dark:text-green-300 uppercase tracking-wider"
            >
              {t("name")}
            </th>
            <th
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap text-start">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-9 w-9 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-start">
                  <div className="flex items-center gap-x-2">
                    <Calendar className="h-4 w-4 text-green-500 dark:text-green-400 flex-shrink-0" />
                    <div>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-start">
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-green-300 dark:border-green-700 text-green-700 dark:text-green-300 hover:bg-green-50 dark:hover:bg-green-900 flex items-center gap-1"
                    onClick={() =>
