const en = {
  ...
  for: "For",
  createPatientsFirst: "Create patients first to generate reports",

  // --- Visit Dialog translations ---
  ...
  generateClinicalNotesTooltip:
    "Generate clinical notes using AI based on symptoms and observations",
  visitNotesPlaceholder:
    "Enter detailed visit notes, observations, and findings...",
  symptomsPlaceholder: "Patient reported symptoms",
  observationsPlaceholder: "Clinical observations",
  diagnosisPlaceholder: "Primary diagnosis",
  treatmentPlaceholder: "Treatment provided",
  medicationsPlaceholder: "Prescribed medications",
  vitalsPlaceholder: "BP, HR, Temp, etc.",
  ...
  followUpInstructionsPlaceholder:
    "Instructions for the patient's follow-up care...",
  titleRequired: "Title is required",
  dateRequired: "Date is required",
  timeRequired: "Time is required",
  followUpDateRequired: "Follow-up date is required",
  followUpTimeRequired: "Follow-up time is required",
  ...
  "1.5hours": "1.5 hours",
  "2+hours": "2+ hours",
  visitTitlePlaceholder: "E.g. Follow-up Appointment, Blood Test Results",
  addingVisit: "Adding Visit...",
  ...
  noteRestoredSuccess: "Note restored successfully",
  editNote: "Edit Note",
  ...
  errorRestoringNote: "Error restoring note",
