import { FieldItem } from "@/app/_components/template/FieldItem";
    ...
    >
      <AccordionTrigger className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-slate-700 group w-full text-left">
        <div className="flex items-center w-full flex-grow pointer-events-none">
          <div className="flex items-center justify-center h-7 w-7 bg-green-100 dark:bg-green-900/30 rounded-full mr-3 text-green-600 dark:text-green-400">
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
                <GripVerticalIcon className="h-4 w-4 text-gray-400 mr-1" />
                Fields
              </h4>
            ...
            <div className="text-center py-6 border border-dashed border-green-200 dark:border-green-900 rounded-lg bg-green-50/50 dark:bg-green-900/10">
              ...
              {!isViewMode && (
                <Button
                  ...
                  onClick={onAddField}
                >
                  <CirclePlusIcon className="mr-1 h-3 w-3" />
                  Add Field
                </Button>
              )}
            </div>
