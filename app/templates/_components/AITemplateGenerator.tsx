...
export function AITemplateGenerator({ onGenerate }: AITemplateGeneratorProps) {
  ...
  return (
    <div className="space-y-4 p-6 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-lg border border-green-100 dark:border-green-900">
      <div className="flex items-center gap-2 text-green-700 dark:text-green-400">
        <Sparkles className="h-5 w-5" />
        <h3 className="text-lg font-semibold bg-gradient-to-r from-green-600 to-green-800 dark:from-green-400 dark:to-green-600 bg-clip-text text-transparent">
      ...
      <div className="space-y-3">
        <div>
          ...
          <Input
            ...
            className="w-full border-gray-300 dark:border-slate-600 focus:border-green-500 focus:ring-green-500 dark:focus:border-green-400 dark:focus:ring-green-400 dark:bg-slate-700/70"
          />
        </div>
        ...
        <div>
          ...
          <Textarea
            ...
            className="w-full resize-none border-gray-300 dark:border-slate-600 focus:border-green-500 focus:ring-green-500 dark:focus:border-green-400 dark:focus:ring-green-400 dark:bg-slate-700/70"
            rows={3}
          />
        </div>
      </div>
      ...
      <Button
        ...
        className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 dark:from-green-700 dark:to-green-800 dark:hover:from-green-600 dark:hover:to-green-700 text-white transition-all duration-300 shadow-md hover:shadow-lg"
      >
        {isLoadingTemplate ? (
          <>
